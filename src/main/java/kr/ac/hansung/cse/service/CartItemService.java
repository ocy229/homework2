...
public class CartItemService {
	...
	public void plusQuantityCartItem(CartItem cartItem) {
		cartItemDao.plusQuantityCartItem(cartItem);
	}
	
	public void minusQuantityCartItem(CartItem cartItem) {
		cartItemDao.minusQuantityCartItem(cartItem);
	}
